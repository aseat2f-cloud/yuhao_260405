...
const COURSE_DATA: CourseCategory[] = [
  ...
  },
  {
    ...
    classes: [
      { name: '學測數學班', desc: '學測範圍總複習與難題解析', age: '升高三/高三上/高三下', summerTime: '週一至五 09:00', semesterTime: '週六 13:30', objectives: '針對學測數學範圍進行地毯式複習，強化跨單元整合與解題速度。', target: '高三考生，目標學測數學滿級分。', features: ['學測重點觀念總整理', '混合題型與素養題攻略', '高強度模考實戰演練', '錯題分析與弱點補強'], roadmap: ['暑期: 1-2冊總複習', '開學: 3-4冊總複習', '考前: 全範圍模考衝刺'] },
      { name: '學測英文班', desc: '模擬試題演練與翻譯寫作衝刺', age: '升高三/高三上/高三下', summerTime: '週一至五 13:30', semesterTime: '週六 10:00', objectives: '透過大量模考題型演練，維持語感與解題手感，衝刺學測英文高分。', target: '高三考生，目標學測英文頂標以上。', features: ['每週一份全真模擬試題', '翻譯寫作即時批改檢討', '時事關鍵字彙補充', '閱讀測驗速讀技巧'], roadmap: ['暑期: 文法單字總複習', '開學: 歷屆試題全攻略', '考前: 寫作與翻譯衝刺'] },
      { name: '學測國文班', desc: '學測國綜與國寫全攻略，精準奪分', age: '升高三/高三上/高三下', summerTime: '週五 09:00', semesterTime: '週日 09:00', objectives: '全面複習學測國文範圍，精準掌握國寫得分關鍵。', target: '高三考生，目標國文滿級分者。', features: ['學測國綜重點整理', '國寫作文模組化訓練', '歷屆試題深度解析', '考前猜題與模考'], roadmap: ['暑期: 基礎觀念複習', '開學: 歷屆試題演練', '考前: 國寫與總複習'] },
      { name: '學測自然班', desc: '自然科學全範圍複習與模考，衝刺頂大', age: '升高三/高三上/高三下', summerTime: '週四 13:30', semesterTime: '週日 13:30', objectives: '整合高中物理化學全範圍，強化解題邏輯與速度。', target: '高三自然組考生。', features: ['自然全範圍觀念整合', '高難度題型破解技巧', '全真模擬考實戰', '考前重點精華掃描'], roadmap: ['暑期: 基礎範圍複習', '開學: 進階題型演練', '考前: 全範圍模考衝刺'] },
      { name: '高三進度班', desc: '校內進度同步強化，掌握高中最後一哩路', age: '升高三/高三上/高三下', summerTime: '週一至五 18:30', semesterTime: '週六 18:30 / 週日 09:00', objectives: '同步學校進度，深化核心概念，應對校內段考與學測延伸。', target: '高三學生，追求校內成績優異與進階實力者。', features: ['各校版本精準對接', '學測與進度雙軌整合', '資深名師親自解惑', '考前重點突破訓練'], roadmap: ['第一階段: 高三上核心課程', '第二階段: 段考衝刺專題', '第三階段: 分科測驗銜接'] },
    ]
  },
  {
    id: 'study_hall',
