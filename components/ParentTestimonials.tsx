...
const TESTIMONIALS = [
  { id: 1, name: '林O妤 媽媽', role: '國小五年級家長', content: '老師非常有耐心，孩子原本很排斥數學，現在每天都主動算題目，進步真的看的見！', rating: 5 },
  { id: 2, name: '陳O翰 爸爸', role: '國中九年級家長', content: '會考衝刺班的規劃很紮實，模擬考後的分析對孩子幫助很大，最後順利考上建中。', rating: 5 },
  { id: 3, name: '張O芸 媽媽', role: '高中二年級家長', content: '這裡的物理老師解題超強，觀念講得很清楚，小孩段考成績直接從及格邊緣衝到班排第一。', rating: 5 },
  { id: 4, name: '黃O勳 爸爸', role: '國小資優班家長', content: '科學實驗課很有趣，孩子回家都會分享今天做了什麼，對培養學習興趣很有幫助。', rating: 5 },
  { id: 5, name: '李O璇 媽媽', role: '國中七年級家長', content: '小班制教學真的很棒，老師能顧到每個學生，也會定期跟家長回報狀況，很放心。', rating: 5 },
  { id: 6, name: '吳O哲 爸爸', role: '高中一年級家長', content: '英文老師的口音很標準，上課氣氛活潑，孩子英文聽說能力進步很多。', rating: 5 },
  { id: 7, name: '劉O彤 媽媽', role: '國小三年級家長', content: '安親課輔很用心，作業都會確實檢查，讓雙薪家庭的我們無後顧之憂。', rating: 5 },
  { id: 8, name: '蔡O宇 爸爸', role: '國中八年級家長', content: '理化實驗課讓孩子親手操作，不再只是死背公式，對觀念理解很有幫助。', rating: 5 },
  { id: 9, name: '楊O安 媽媽', role: '高中三年級家長', content: '學測衝刺班的備審資料輔導很專業，讓孩子順利通過一階篩選。', rating: 5 },
  { id: 10, name: '趙O睿 爸爸', role: '國小六年級家長', content: '私中特訓班的教材編排很好，針對考題趨勢練習，讓孩子順利考上目標私中。', rating: 5 },
  { id: 11, name: '孫O晴 媽媽', role: '國中九年級家長', content: '模擬考後的落點分析很準確，讓我們在填志願時更有方向。', rating: 5 },
  { id: 12, name: '周O廷 爸爸', role: '高中二年級家長', content: 'K書中心的環境很好，讀書氛圍很棒，孩子很喜歡去那裡自習。', rating: 5 },
  { id: 13, name: '鄭O潔 媽媽', role: '國小四年級家長', content: '作文老師引導孩子觀察生活，寫出來的文章變得很生動有趣。', rating: 5 },
  { id: 14, name: '王O凱 爸爸', role: '國中八年級家長', content: '數學老師會用生活例子解說，讓孩子覺得數學其實沒那麼難。', rating: 5 },
  { id: 15, name: '許O涵 媽媽', role: '高中一年級家長', content: '高一先修班讓孩子提前適應高中課程，開學後學習比較輕鬆。', rating: 5 },
  { id: 16, name: '何O翔 爸爸', role: '國小五年級家長', content: '資優數學班的邏輯訓練對孩子思考很有幫助，不只數學變好，其他科也進步了。', rating: 5 },
];
